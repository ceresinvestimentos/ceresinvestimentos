...
<form id="fiscalForm">
    ...
    <input type="text" class="input-wtd" name="numeroDaNota"><br>
    <p style="color: black; margin: 0; font-size: 1rem;">CPF/CNPJ:</p>
    <input type="text" class="input-wtd" name="cpf-cnpj"><br>
    <p style="color: black; margin: 0; font-size: 1rem;">Data de Vencimento:</p>
    <input type="date" class="input-wtd" name="dataDeVencimento"><br>
    <p style="color: black; margin: 0; font-size: 1rem;">Valor Líquido:</p>
    <input type="text" class="input-wtd" name="valorLiquido"><br>
</form>