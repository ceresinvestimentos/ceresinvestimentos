        ...
        <div class="container-fluid" id="sixcards">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6" id="ComeceInvestir">
                        <a href="#">
                            <div class="sixCardsimg">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 cardstop" id="escolhida1">
